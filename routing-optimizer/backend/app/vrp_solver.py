"""
VRP Solver - Risolve il Capacitated Vehicle Routing Problem usando Google OR-Tools
"""
import math
import time
...
class VRPSolver:
    ...
    def compute_euclidean_distance_matrix(self) -> List[List[float]]:
        """
        Calcola la matrice delle distanze euclidee tra tutte le locazioni.
        Usa la formula di Haversine per distanze geografiche accurate.
        
        Returns:
            Matrice delle distanze in metri
        """
    ...
    def solve(self) -> OptimizationResult:
        ...
        self.distance_matrix = self.compute_euclidean_distance_matrix()
        ...
        return OptimizationResult(
            ...
            message="Ottimizzazione completata con successo"
        )
